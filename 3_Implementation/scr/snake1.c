...
*/
#include <stdio.h> //include stardard input and output
#include <time.h>  //to get date and time information
#include <stdlib.h> //standard library for memmory allocation
#include <conio.h> //console input output
#include<time.h>  //to get date and time
#include<ctype.h> //cantain inbuilt function to handle characters in c/c++
#include <time.h>
#include <windows.h>//declaration for all the function in the windows API.
#include <process.h>
...
int main()
{
    ...
    system("cls");
    system("color 4f"); //This is for background colour
